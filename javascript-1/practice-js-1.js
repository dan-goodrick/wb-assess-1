...
const trueOrFalse = function (data) {
  if (data) return true;
  return false;
};
//////////////////PROBLEM 6////////////////////
...
let me = {
  ...
  state: "Utah",
  age: 44,
  greeter: function(){`Hello! My name is ${me.firstName} and I live in ${me.state}`},
};
//////////////////PROBLEM 12////////////////////
/* 
...
function carFactory(make, model, year){
  const car =   {
    ...
    model: model,
    year: year,
    // isNew: function(){year > 2018 ? true : false} // why doesn't this work?
  }
  car.isNew = year > 2018 ? true : false
  return car
}